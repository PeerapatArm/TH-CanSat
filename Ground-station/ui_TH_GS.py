...
# Form implementation generated from reading ui file 'ui_TH_GS.ui'
#
...
"color: white")
        ...
        self.T_ACCX = QtWidgets.QLabel(self.frame)
        self.T_ACCX.setGeometry(QtCore.QRect(360, 20, 62, 21))
        self.T_ACCX.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_ACCX.setAlignment(QtCore.Qt.AlignCenter)
        self.T_ACCX.setObjectName("T_ACCX")
        self.Can_ACCX_graph = PlotWidget(self.frame)
        self.Can_ACCX_graph.setGeometry(QtCore.QRect(360, 50, 251, 121))
        self.Can_ACCX_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_ACCX_graph.setObjectName("Can_ACCX_graph")
        self.Can_ACCY_graph = PlotWidget(self.frame)
        self.Can_ACCY_graph.setGeometry(QtCore.QRect(360, 220, 251, 121))
        self.Can_ACCY_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_ACCY_graph.setObjectName("Can_ACCY_graph")
        self.Can_ACCZ_graph = PlotWidget(self.frame)
        self.Can_ACCZ_graph.setGeometry(QtCore.QRect(360, 390, 251, 121))
        self.Can_ACCZ_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_ACCZ_graph.setObjectName("Can_ACCZ_graph")
        self.ACCX = QtWidgets.QLabel(self.frame)
        self.ACCX.setGeometry(QtCore.QRect(550, 20, 62, 21))
        self.ACCX.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.ACCX.setAlignment(QtCore.Qt.AlignCenter)
        self.ACCX.setObjectName("ACCX")
        self.T_ACCY = QtWidgets.QLabel(self.frame)
        self.T_ACCY.setGeometry(QtCore.QRect(360, 190, 62, 21))
        self.T_ACCY.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_ACCY.setAlignment(QtCore.Qt.AlignCenter)
        self.T_ACCY.setObjectName("T_ACCY")
        self.ACCY = QtWidgets.QLabel(self.frame)
        self.ACCY.setGeometry(QtCore.QRect(550, 190, 62, 21))
        self.ACCY.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.ACCY.setAlignment(QtCore.Qt.AlignCenter)
        self.ACCY.setObjectName("ACCY")
        self.T_ACCZ = QtWidgets.QLabel(self.frame)
        self.T_ACCZ.setGeometry(QtCore.QRect(360, 360, 62, 21))
        self.T_ACCZ.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_ACCZ.setAlignment(QtCore.Qt.AlignCenter)
        self.T_ACCZ.setObjectName("T_ACCZ")
        self.ACCZ = QtWidgets.QLabel(self.frame)
        self.ACCZ.setGeometry(QtCore.QRect(540, 360, 85, 21))
        self.ACCZ.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.ACCZ.setAlignment(QtCore.Qt.AlignCenter)
        self.ACCZ.setObjectName("ACCZ")
        self.Can_GYRX_graph = PlotWidget(self.frame)
        self.Can_GYRX_graph.setGeometry(QtCore.QRect(700, 50, 251, 121))
        self.Can_GYRX_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_GYRX_graph.setObjectName("Can_GYRX_graph")
        self.Can_GYRY_graph = PlotWidget(self.frame)
        self.Can_GYRY_graph.setGeometry(QtCore.QRect(700, 220, 251, 121))
        self.Can_GYRY_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_GYRY_graph.setObjectName("Can_GYRY_graph")
        self.Can_GYRZ_graph = PlotWidget(self.frame)
        self.Can_GYRZ_graph.setGeometry(QtCore.QRect(700, 390, 251, 121))
        self.Can_GYRZ_graph.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Can_GYRZ_graph.setObjectName("Can_GYRZ_graph")
        self.T_GYRX = QtWidgets.QLabel(self.frame)
        self.T_GYRX.setGeometry(QtCore.QRect(710, 20, 61, 21))
        self.T_GYRX.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_GYRX.setAlignment(QtCore.Qt.AlignCenter)
        self.T_GYRX.setObjectName("T_GYRX")
        self.T_GYRY = QtWidgets.QLabel(self.frame)
        self.T_GYRY.setGeometry(QtCore.QRect(710, 190, 61, 21))
        self.T_GYRY.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_GYRY.setAlignment(QtCore.Qt.AlignCenter)
        self.T_GYRY.setObjectName("T_GYRY")
        self.T_GYRZ = QtWidgets.QLabel(self.frame)
        self.T_GYRZ.setGeometry(QtCore.QRect(710, 360, 61, 21))
        self.T_GYRZ.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.T_GYRZ.setAlignment(QtCore.Qt.AlignCenter)
        self.T_GYRZ.setObjectName("T_GYRZ")
        self.GYRX = QtWidgets.QLabel(self.frame)
        self.GYRX.setGeometry(QtCore.QRect(880, 20, 71, 21))
        self.GYRX.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.GYRX.setAlignment(QtCore.Qt.AlignCenter)
        self.GYRX.setObjectName("GYRX")
        self.GYRY = QtWidgets.QLabel(self.frame)
        self.GYRY.setGeometry(QtCore.QRect(880, 190, 71, 21))
        self.GYRY.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.GYRY.setAlignment(QtCore.Qt.AlignCenter)
        self.GYRY.setObjectName("GYRY")
        self.GYRZ = QtWidgets.QLabel(self.frame)
        self.GYRZ.setGeometry(QtCore.QRect(880, 360, 71, 21))
        self.GYRZ.setStyleSheet("font: 25 10pt \"Bahnschrift Light SemiCondensed\";\n"
"color: white")
        self.GYRZ.setAlignment(QtCore.Qt.AlignCenter)
        self.GYRZ.setObjectName("GYRZ")
...
"color: white")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.T_ACCX.setText(_translate("MainWindow", "ACCX"))
        self.ACCX.setText(_translate("MainWindow", "0.00"))
        self.T_ACCY.setText(_translate("MainWindow", "ACCY"))
        self.ACCY.setText(_translate("MainWindow", "0.00"))
        self.T_ACCZ.setText(_translate("MainWindow", "ACCZ"))
        self.ACCZ.setText(_translate("MainWindow", "0.00"))
        self.T_GYRX.setText(_translate("MainWindow", "GYRX"))
        self.T_GYRY.setText(_translate("MainWindow", "GYRY"))
        self.T_GYRZ.setText(_translate("MainWindow", "GYRZ"))
        self.GYRX.setText(_translate("MainWindow", "0.00"))
        self.GYRY.setText(_translate("MainWindow", "0.00"))
        self.GYRZ.setText(_translate("MainWindow", "0.00"))
